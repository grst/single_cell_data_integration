...
```{python}
adata = sc.read_h5ad("results/data_integrated/batch_effects_removed/harmony-patient/adata.h5ad")
```
...
fig.legend(**make_legend_elements("cell_type"), loc='upper left', 
           bbox_to_anchor=(0.135, 0.40), ncol=1, title="cell type")
fig.savefig("results/data_integrated/batch_effects_removed/harmony-patient/umap_dataset.jpg", quality=100, dpi=300)
```
